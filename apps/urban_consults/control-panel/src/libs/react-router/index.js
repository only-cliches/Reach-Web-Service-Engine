define("react-router", ["react","prop-types","react-is"], function(__WEBPACK_EXTERNAL_MODULE__1__, __WEBPACK_EXTERNAL_MODULE__2__, __WEBPACK_EXTERNAL_MODULE__5__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var warning = _interopDefault(__webpack_require__(0));

var createContext = _interopDefault(__webpack_require__(8));

var invariant = _interopDefault(__webpack_require__(3));

var pathToRegexp = _interopDefault(__webpack_require__(10));

var reactIs = __webpack_require__(5);

var hoistStatics = _interopDefault(__webpack_require__(12));
...
/* harmony import */ var tiny_warning__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(0);
...
var tiny_warning_esm = __webpack_require__(0);
...
function createBrowserHistory(props) {
  ...
  function push(path, state) {
     true ? Object(tiny_warning_esm["default"])(!(history_typeof(path) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to push when the 1st ' + 'argument is a location-like object that already has state; it is ignored') : undefined;
    var action = 'PUSH';
  ...
  function replace(path, state) {
     true ? Object(tiny_warning_esm["default"])(!(history_typeof(path) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to replace when the 1st ' + 'argument is a location-like object that already has state; it is ignored') : undefined;
    var action = 'REPLACE';
    var location = createLocation(path, state, createKey(), history.location);
    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
      if (!ok) return;
